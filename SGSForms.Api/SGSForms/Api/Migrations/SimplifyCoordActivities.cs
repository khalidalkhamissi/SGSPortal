...
[Migration("20260819142141_SimplifyCoordActivities")]
public class SimplifyCoordActivities : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropColumn("ElapseMinus", "CoordinationActivities");
		migrationBuilder.DropColumn("ElapsePlus", "CoordinationActivities");
		migrationBuilder.DropColumn("PlannedFinish", "CoordinationActivities");
		migrationBuilder.DropColumn("PlannedStart", "CoordinationActivities");
		migrationBuilder.RenameColumn("DepPaxE", "CoordinationSheets", "DepPaxY");
		migrationBuilder.RenameColumn("ArrPaxE", "CoordinationSheets", "ArrPaxY");
		migrationBuilder.AddColumn<string>("Remarks", "CoordinationActivities", "longtext", null, null, rowVersion: false, null, nullable: true).Annotation("MySql:CharSet", "utf8mb4");
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropColumn("Remarks", "CoordinationActivities");
		migrationBuilder.RenameColumn("DepPaxY", "CoordinationSheets", "DepPaxE");
		migrationBuilder.RenameColumn("ArrPaxY", "CoordinationSheets", "ArrPaxE");
		migrationBuilder.AddColumn<int>("ElapseMinus", "CoordinationActivities", "int", null, null, rowVersion: false, null, nullable: true);
		migrationBuilder.AddColumn<int>("ElapsePlus", "CoordinationActivities", "int", null, null, rowVersion: false, null, nullable: true);
		migrationBuilder.AddColumn<TimeOnly>("PlannedFinish", "CoordinationActivities", "time(6)", null, null, rowVersion: false, null, nullable: true);
		migrationBuilder.AddColumn<TimeOnly>("PlannedStart", "CoordinationActivities", "time(6)", null, null, rowVersion: false, null, nullable: true);
	}
