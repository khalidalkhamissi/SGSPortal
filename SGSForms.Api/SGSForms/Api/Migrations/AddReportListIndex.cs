...
[Migration("20260711153011_AddReportListIndex")]
public class AddReportListIndex : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.CreateIndex("IX_DepartureReports_Status_FlightDate", "DepartureReports", new string[2] { "Status", "FlightDate" });
		migrationBuilder.CreateIndex("IX_ArrivalReports_Status_FlightDate", "ArrivalReports", new string[2] { "Status", "FlightDate" });
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropIndex("IX_DepartureReports_Status_FlightDate", "DepartureReports");
		migrationBuilder.DropIndex("IX_ArrivalReports_Status_FlightDate", "ArrivalReports");
	}
