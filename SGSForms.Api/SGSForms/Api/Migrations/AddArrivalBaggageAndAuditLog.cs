...
[Migration("20260621145449_AddArrivalBaggageAndAuditLog")]
public class AddArrivalBaggageAndAuditLog : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.AddColumn<int>("BagTotal", "ArrivalReports", "int", null, null, rowVersion: false, null, nullable: false, 0);
		migrationBuilder.CreateTable("AuditLogs", delegate(ColumnsBuilder table)
		{
			...
			OperationBuilder<AddColumnOperation> at = table.Column<DateTime>("datetime(6)");
			OperationBuilder<AddColumnOperation> userId = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> userName = table.Column<string>("longtext").Annotation("MySql:CharSet", "utf8mb4");
			OperationBuilder<AddColumnOperation> userRole = table.Column<string>("longtext").Annotation("MySql:CharSet", "utf8mb4");
			OperationBuilder<AddColumnOperation> stationId = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true);
			OperationBuilder<AddColumnOperation> stationCode = table.Column<string>("longtext", null, null, rowVersion: false, null, nullable: true).Annotation("MySql:CharSet", "utf8mb4");
			int? maxLength = 20;
			OperationBuilder<AddColumnOperation> action = table.Column<string>("varchar(20)", null, maxLength).Annotation("MySql:CharSet", "utf8mb4");
			maxLength = 20;
			return new
			{
				Id = id,
				...
				Action = action,
				ReportKind = table.Column<string>("varchar(20)", null, maxLength).Annotation("MySql:CharSet", "utf8mb4"),
				ReportId = table.Column<int>("int", null, null, rowVersion: false, null, nullable: true),
				FlightNo = table.Column<string>("longtext", null, null, rowVersion: false, null, nullable: true).Annotation("MySql:CharSet", "utf8mb4"),
				Details = table.Column<string>("longtext", null, null, rowVersion: false, null, nullable: true).Annotation("MySql:CharSet", "utf8mb4")
			};
		}, null, table =>
		{
	...
	protected override void Down(MigrationBuilder migrationBuilder)
	{
		...
		migrationBuilder.DropColumn("BagTotal", "ArrivalReports");
	}
