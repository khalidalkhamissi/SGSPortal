...
[Migration("20260707194818_AddPaxVip")]
public class AddPaxVip : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.AddColumn<int>("PaxVip", "DepartureReports", "int", null, null, rowVersion: false, null, nullable: false, 0);
		migrationBuilder.AddColumn<int>("PaxVip", "ArrivalReports", "int", null, null, rowVersion: false, null, nullable: false, 0);
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropColumn("PaxVip", "DepartureReports");
		migrationBuilder.DropColumn("PaxVip", "ArrivalReports");
	}
