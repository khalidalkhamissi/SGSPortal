...
[Migration("20260818193242_DropCoordSvTcToc")]
public class DropCoordSvTcToc : Migration
{
	protected override void Up(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.DropColumn("SvTcToc", "CoordinationSheets");
	}

	protected override void Down(MigrationBuilder migrationBuilder)
	{
		migrationBuilder.AddColumn<string>("SvTcToc", "CoordinationSheets", "longtext", null, null, rowVersion: false, null, nullable: true).Annotation("MySql:CharSet", "utf8mb4");
	}
